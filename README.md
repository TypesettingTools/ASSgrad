...
Currently, because I am an ASS, it only works with vertical color gradients.
...
The current options are Band Size, Band overlap, and l,t,r,b (left, top, right, bottom) clipbox expansion.
